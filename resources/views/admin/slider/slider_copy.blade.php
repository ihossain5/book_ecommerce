                ...
                <div class="modal-body">
                    <form class="sliderAddForm" method="POST"> @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" placeholder="Type description"
                                id="description"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Precedence</label>
                            <input type="text" class="form-control" name="precedence" placeholder="Type precedence" />
                        </div>
                        <div class="form-group ">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        ...
                        var row = $('<tr>')
                            .append((response.data.precedence == null ? '`<td> N/A </td>`' : '`<td>' +
                            response.data.precedence + '</td>`'))
                            .append(
                ...
                success: function(response) {
                    if (response.success == true) {
                        ...
                        if (response.data.image) {
                            ...
                            $('.big_image').find('.dropify-wrapper').removeClass("dropify-wrapper").addClass(
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success === true) {
                                Swal.fire(
                                    'Deleted!', "" + response.data.message + "", 'success'
                                )
