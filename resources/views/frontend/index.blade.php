                ...
                <div class="item">
                    <div class="new_published_card">
                        ...
                        <div class="content_wrapper book_card_content">
                            ...
                            <a href="{{route('frontend.book.details',[$book->book_id])}}" class="btn_buy_now">Buy
                                Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="writer_content">
                        <a href="{{route('frontend.author.details',[$author->author_id])}}" class="d-block tex-reset">
                            <img class="img-fluid w-100" src="{{ asset('images/'.$author->photo) }}" alt="Card image">
                    ...
                    <div class="book_card_wrapper">
                        <div class="image_wrapper">
                            <a href="{{route('frontend.book.details',[$popularBook->book_id])}}"
                                class="d-block text-reset">
                                <img class="img-fluid w-100" src="{{ asset('images/'.$popularBook->cover_image) }}"
                                    alt="book image">
                            </a>
                            @if ($popularBook->discounted_percentage != null || $popularBook->discounted_percentage !=
                            0)
                            <div class="red_tag">
                                <svg xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 49 49"
                                    fill="none">
                        ...
                        <div class="content_wrapper book_card_content">
                            ...
                            <div class="price_wrapper">
                                @if ($popularBook->discounted_percentage != null || $popularBook->discounted_percentage
                                != 0)
                                <h6 class="discount">{{englishTobangla($popularBook->regular_price)}} টাকা</h6>
                                <h5 class="regular">{{englishTobangla($popularBook->discounted_price)}} টাকা</h5>
                                @else
                                <h5 class="regular">{{englishTobangla($popularBook->discounted_price)}} টাকা</h5>
                                @endif

                            </div>
                            <a href="{{route('frontend.book.details',[$popularBook->book_id])}}" class="btn_buy_now">Buy
                                Now</a>
                        </div>
                    </div>
                </div>
