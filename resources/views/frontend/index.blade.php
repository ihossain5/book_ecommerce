                ...
                <div class="most_selling_book_carousel common_carousel owl-carousel">
                    @if (!empty($popularBooks))
                        ...
                        <div class="item">
                            <div class="book_card_wrapper">
                                <div class="image_wrapper">
                                    <a href="{{route('frontend.book.details',[$popularBook->book_id])}}" class="d-block text-reset">
                                        <img class="img-fluid w-100" src="{{ asset('images/'.$popularBook->cover_image) }}" alt="book image">
                                    </a>
                                ...
                                <div class="content_wrapper book_card_content">
                                    ...
                                    <a href="{{route('frontend.book.details',[$popularBook->book_id])}}" class="btn_buy_now">Buy Now</a>
                                </div>
                            </div>
                        </div>
                        @endif
