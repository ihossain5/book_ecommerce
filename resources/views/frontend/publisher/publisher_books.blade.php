...
@section('title', 'Publicaiton Books')
...
<section class="banner_section pt-20 pb-56">
    <div class="container">
        <div class="banner_with_title">
            ...
            <h3 class="banner_title">{{ $publication_name }}</h3>
            <input type="hidden" name="publication_id" id="publication_id" value="{{ $publicaiton_info->publication_id }}">
        </div>
    </div>
</section>
                            ...
                            <div>
                                <div class="search_group">
                                    <input class="form-control" placeholder="খুঁজে দেখুন" type="text"
                                        name="writer_search_key_sidebar" id="writer_search_key_sidebar" onkeypress="author_sidebar_filter()" onkeyup="author_sidebar_filter()">
                            ...
                            <div>
                                <div class="search_group">
                                    <input class="form-control search_key" placeholder="খুঁজে দেখুন" type="text"
                                        name="publisher_search_key_sidebar" id="publisher_search_key_sidebar" onkeypress="publisher_sidebar_filter()" onkeyup="publisher_sidebar_filter()">
                                    <button><img src="{{ asset('frontend/assets/images/icons/search_black_24dp1.svg') }}" alt=""></button>
                                </div>
                            </div>
...
<script>
    ...
    var book_fetch_config = {
                routes: {
                    filter: "{!! route('publishers.filter') !!}",
