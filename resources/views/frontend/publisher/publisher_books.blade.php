        ...
        <div class="container">
            <div class="banner_with_title">
                ...
                <input type="hidden" name="publication_id" id="publication_id"
                    value="{{ $publicaiton_info->publication_id }}">
            </div>
        </div>
    </section>
                            ...
                            <div class="filter_content">
                                ...
                                <div class="minmax_price_range">
                                    ...
                                    <div class="minmax_input_wapper">
                                        ...
                                        <button type="butotn" onclick="filterByPrice()"
                                            class="minmax_btn">ক্লিক</button>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="image_wrapper">
                                                ...
                                                <div class="npb_hoberable">
                                                    <button class="addtocart"
                                                        onclick="addToCart({{ $book->book_id }})">Add to cart</button>
                                                </div>
                                        ...
                                        <div class="rateYo ratSerialId{{ $key }}"
                                            data-user_rating="{{getTotalRating($book->reviews)}}"></div>
                                                ...
                                                <div class="price_wrapper">
                                                    @if ($book->discounted_percentage != null || $book->discounted_percentage != 0)
                                                        <h6 class="discount">
                                                            {{ englishTobangla($book->regular_price) }} টাকা</h6>
                                                        <h5 class="regular">
                                                            {{ englishTobangla($book->discounted_price) }} টাকা</h5>
                                                    @else
                                                        <h5 class="regular">
                                                            {{ englishTobangla($book->discounted_price) }} টাকা</h5>
                                                    @endif
