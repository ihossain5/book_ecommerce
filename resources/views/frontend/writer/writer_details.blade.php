            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="writer_details_image">
                        <img class="img-fluid w-100" src="{{ asset('images/' . $author_info->photo) }}" alt="{{ $author_info->name }}">
                    </div>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="filter_content">
                            ...
                            <div>
                                <div class="search_group search_key">
                                    <input class="form-control" placeholder="খুঁজে দেখুন" type="text"
                                    name="category_search_key_sidebar" id="category_search_key_sidebar" onkeypress="category_filter_sidebar_filter()" onkeyup="category_filter_sidebar_filter()">
                                    <button><img src="{{ asset('frontend/assets/images/icons/search_black_24dp1.svg') }}" alt=""></button>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="book_card_wrapper">
                                ...
                                <div class="content_wrapper book_card_content">
                                    ...
                                    {{-- <button class="btn_buy_now" onclick="addToCart({{ $author_book->book_id }})">Buy Now</button> --}}
                                </div>
                            </div>
                        </div>
                        @endforeach
