                    ...
                    <div class="user_login_dropdown">
                        <ul>
                            ...
                            <li><a href="{{ route('logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">সাইন
                                    আউট</a>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a href="{{ route('frontend.publishers')}}"><button class="writer_btn">সব প্রকাশনী দেখুন
            ...
            <ul class="side_menu">
                ...
                <li>
                    ...
                    <ul class="multi_level d-none">
                        ...
                        @endforeach
                        @endif
                        <li><a href="{{ route('frontend.publishers') }}"><button class="writer_btn">সব প্রকাশনী দেখুন
                                    <img src="{{ asset('frontend/assets/images/icons/fi_arrow-right.svg') }}"
                                        alt=""></button></a></li>
                    </ul>
                </li>
